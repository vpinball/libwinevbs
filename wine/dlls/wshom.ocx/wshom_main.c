...
/* These IID_* are also emitted by scrrun's typelib header; rename ours
 * so the linker sees distinct symbols within the unified library. */
#define IID_IDrive            wshom_unused_IID_IDrive
#define IID_IFile             wshom_unused_IID_IFile
#define IID_IFileCollection   wshom_unused_IID_IFileCollection
#define IID_IFolder           wshom_unused_IID_IFolder
#define IID_IFolderCollection wshom_unused_IID_IFolderCollection
#define IID_ITextStream       wshom_unused_IID_ITextStream
#endif
#include "wshom.h"
#ifdef __LIBWINEVBS__
#undef IID_IDrive
#undef IID_IFile
#undef IID_IFileCollection
#undef IID_IFolder
#undef IID_IFolderCollection
#undef IID_ITextStream
#endif
#include "rpcproxy.h"
