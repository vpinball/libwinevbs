...
/* libwinevbs links scrrun and wshom.ocx into the same library; rename the
 * file-scope helpers so they don't collide with their scrrun counterparts. */
#define get_typeinfo     wshom_get_typeinfo
#define init_classinfo   wshom_init_classinfo
#define release_typelib  wshom_release_typelib
#endif
